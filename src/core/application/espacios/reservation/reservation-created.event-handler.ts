...
handle(command:ReservationWasCreatedEvent):void{
    console.log(`checking availability of hot desktops date ${command.payload.date}`)
    ...
    console.log(`you have been granted acces to a hot desktop for your meeting room reservation, on day
